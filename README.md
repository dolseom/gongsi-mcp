...
| `find_precedents` | "다른 회사는 어떻게 썼나" — 같은 유형 공시를 회사당 1건씩 원문과 함께. **최대 5년치**까지 거슬러 찾는다(회사 지정 불필요). 최신부터 훑어 사례가 모이면 멈추므로 보통 몇 초에 끝나고, 1년을 넘기면 표본 스캔으로 바뀌며 실제로 훑은 구간(coverage)을 함께 돌려준다 |
