...
- **투자·재무 분석이 목적** — 재무비교·내부자거래·XBRL은 [korean-dart-mcp](https://github.com/chrisryugj/korean-dart-mcp) 같은 투자 관점 MCP가 훨씬 잘합니다 (보완 관계 — 같이 설치해도 됩니다)
...
| 기능 | 일반 DART MCP (투자·재무 관점) | **gongsi-mcp** |
|---|:---:|:---:|
| 관점 | 공시를 **읽는** 사람 (투자자) | 공시를 **제출하는** 사람 (담당자) |
| 공정위 공시(J) 대상 판정 · 기준금액 계산 | ❌ | ✅ 근거 조문·계산식 동봉 |
| 공시기한 계산 (영업일·공휴일) | ❌ | ✅ 공휴일 데이터 공식 공고 대조 검증 (2026·2027, 노동절 신설 반영) |
| 예상 과태료 (별표9 + 고시 2종) | ❌ | ✅ 거래금액별 비율·가중감경·상한까지 |
| 공정위 기업집단포털 결합 (계열사 전수·집단 재무) | ❌ (사용 사례 전무) | ✅ 법인등록번호 조인 |
| 공정위 공식 Q&A 근거 제시 | ❌ | ✅ 430건 (2026. 4. 매뉴얼 포함) |
| 기한 감사 (원본 접수일 vs 의결일) | ❌ | ✅ 정정 이전 **원본** 기준 |
| 정정 이전 원본 보존 | 대부분 최종본만 | ✅ 기본값 원본 — 최종본만 보면 지연 판정 자체가 불가능 |
| 제출 전 정합성 자가점검 | ❌ | ✅ 항등식·재합산·문서 간 대사 |
| 검색 절단·부분결과 명시 | 도구마다 다름 | ✅ 모든 응답에 diagnostics·coverage |
...
- [korean-dart-mcp](https://github.com/chrisryugj/korean-dart-mcp) — 투자·재무 분석 관점 DART MCP (보완 관계)
